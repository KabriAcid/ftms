...
try {
    // Fetch all members
    $stmt = $pdo->prepare("SELECT * FROM members WHERE gender = 'Male'");
    $stmt->execute();
    ...
    <div id="main-container">
        ...
        <main id="content">
            <div class="container">
                <div class="row">
                    <div class="col">
                        <h2>Males in the Family</h2>
                        <p>Below is the list of all males in the family.</p>
                    </div>
                </div>
                <div class="container mt-4 box-shadow">
                    <div class="row">
                        <div class="col-12">
                            <h4 class="mb-3 py-4 bold">Male List</h4>
                            <div class="mb-5">
